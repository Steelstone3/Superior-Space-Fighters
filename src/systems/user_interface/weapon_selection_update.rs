        ...
        .with_children(|parent| {
            ...
            parent
                ...
                .with_children(|blaster_parent| {
                    blaster_parent.spawn(weapon_ammo_count_bundle(ammunition.blaster_ammunition));
                })
                .insert(weapon_icon);
            ...
            parent
                .spawn((weapon_icon_node_bundle(), UiImage::new(texture)))
                .with_children(|blaster_parent| {
                    blaster_parent.spawn(weapon_ammo_count_bundle(ammunition.torpedo_ammunition));
                })
                .insert(weapon_icon);
            ...
            parent
                .spawn((weapon_icon_node_bundle(), UiImage::new(texture)))
                .with_children(|blaster_parent| {
                    blaster_parent.spawn(weapon_ammo_count_bundle(ammunition.exotic_ammunition));
                })
                .insert(weapon_icon);
        });
}
